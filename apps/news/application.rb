...
module News
  class Application < Lotus::Application
    configure do
      ...
      #
      layout :application # It will load News::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time News::Action is included
      ...
      # Configure the code that will yield each time News::View is included
      # This is useful for sharing common functionality
      #
